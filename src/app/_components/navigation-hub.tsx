...
import {
  ...
  ChevronRight, Newspaper, BarChart3, PlugZap, Activity,
} from "lucide-react";
...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { group: "Earth Systems", href: "/climate/methodology", label: "Methodology & Sources", icon: <BookOpen className="h-4 w-4" />, desc: "Baselines, data sources & timeline" },
