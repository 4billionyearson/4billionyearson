...
export default function GlobalRankingsTeaser() {
  ...
  return (
    <Link
      ...
      className="mb-3 inline-flex flex-wrap items-center gap-x-1.5 gap-y-1.5 rounded-lg border border-[#D0A65E]/30 bg-[#D0A65E]/5 px-3 py-2.5 text-xs md:text-sm text-gray-300 hover:border-[#D0A65E]/55 hover:bg-[#D0A65E]/10 transition-colors"
    >
      ...
      <span className="ml-auto pl-3 text-[11px] text-teal-300">Rankings, movers & monthly analysis →</span>
    </Link>
  );
}
