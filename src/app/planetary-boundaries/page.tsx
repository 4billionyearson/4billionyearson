...
import { PLANETARY_BOUNDARIES_FAQ } from './planetary-boundaries-faq';
...
export default function PlanetaryBoundariesPage() {
  ...
  return (
    <main>
      ...
      <section className="container mx-auto px-3 md:px-4 pb-8 font-sans text-gray-200">
        <div className="max-w-7xl mx-auto">
          ...
          <StaticFAQPanel headingId="planetary-boundaries-faq-heading" qa={PLANETARY_BOUNDARIES_FAQ} />
          <FaqJsonLd qa={PLANETARY_BOUNDARIES_FAQ} />
        </div>
      </section>
    </main>
