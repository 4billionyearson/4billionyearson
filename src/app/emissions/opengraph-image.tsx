...
export const alt = 'CO₂ Emissions by Country – Rankings & Trends | 4 Billion Years On';
...
const FEATURES = [
  { label: '195+ Countries', detail: 'Annual CO₂ emissions data' },
  { label: 'Per Capita', detail: 'Emissions per person rankings' },
  { label: 'Sector Breakdown', detail: 'Energy · transport · industry' },
  { label: 'Since 1750', detail: 'Full industrial era history' },
];
        ...
        >
          ...
          <div style={{ display: 'flex', marginBottom: '20px' }}>
            <span style={{ fontSize: 20, color: ACCENT_DIM, letterSpacing: 2, textTransform: 'uppercase', fontWeight: 600 }}>
              Rankings &amp; Trends · Updated Annually · OWID
            </span>
          </div>

          <div style={{ display: 'flex', marginBottom: '24px' }}>
            <span style={{ fontSize: 25, color: '#e2e8f0', lineHeight: 1.35, textShadow: '0 2px 8px rgba(0,0,0,0.9)' }}>
              Compare total and per-capita CO₂ emissions across 195+ countries, explore sector breakdowns, and trace the industrial era history back to 1750.
            </span>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '4px' }}>
              <span style={{ fontSize: 18, fontWeight: 700, color: ACCENT }}>
                Country-by-country data · sector breakdown →
              </span>
              <span style={{ fontSize: 14, color: '#6b7280' }}>4billionyearson.org/emissions</span>
            </div>
          </div>
        </div>
      </div>
