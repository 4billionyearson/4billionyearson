  ...
  return (
    <section className="bg-gray-950/90 backdrop-blur-md p-4 md:p-5 rounded-2xl shadow-xl border-2 border-[#D0A65E]">
      ...
      <p className="text-xs text-gray-400 mb-4">
        A once-per-month take on this league table — who led, who shifted, and what the news and climate drivers say
        about why. Generated by Gemini from the ranking data above plus Google Search.
      </p>
