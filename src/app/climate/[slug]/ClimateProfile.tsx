...
function OverviewGrid({ panels }: { panels: OverviewPanel[] }) {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 mb-6">
      {panels.map((panel) => (
        <div key={panel.title} className="rounded-2xl border border-gray-800/60 bg-gray-950/80 backdrop-blur-md shadow-xl overflow-hidden">
    ...
    <main>
      <div className="container mx-auto px-3 md:px-4 pt-2 pb-6 md:pt-4 md:pb-8 font-sans text-gray-200">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          {/* ─── Header (matching climate dashboard style) ─── */}
          <div className="relative z-10 rounded-2xl shadow-xl border-2 border-[#D0A65E]" style={{ background: "linear-gradient(to bottom, #D0A65E 0%, #D0A65E 20px, transparent 20px)" }}>
            <div className="px-4 py-3 md:px-6 md:py-4 rounded-t-[14px]" style={{ backgroundColor: '#D0A65E' }}>
              <nav className="text-xs mb-1 text-[#FFF5E7]/70">
                <Link href="/" className="hover:text-white">Home</Link>
                <span className="mx-1.5">›</span>
                <Link href="/climate" className="hover:text-white">Climate Profiles</Link>
                <span className="mx-1.5">›</span>
            ...
            <div className="bg-gray-950/90 backdrop-blur-md px-4 py-3 md:px-6 md:py-4 rounded-b-[14px]">
          ...
          {loading && (
            <div className="flex items-center justify-center py-32">
              <Loader2 className="h-8 w-8 animate-spin text-[#D0A65E]" />
          ...
          {data && !loading && (
            <>
              ...
              {summary && (
                <div className="bg-gray-950/80 backdrop-blur-md rounded-2xl border border-gray-800/60 p-5 shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                <Link
                  ...
                  className="group block rounded-xl border-2 border-[#D0A65E]/40 bg-gray-950/80 p-4 hover:border-[#D0A65E] hover:bg-gray-900 transition-all"
                >
                  <div className="font-semibold text-[#D0A65E] text-sm">Full Climate Data</div>
                  <div className="text-xs text-gray-500 mt-1">Detailed charts and monthly comparisons for {pageTitle}</div>
                </Link>
