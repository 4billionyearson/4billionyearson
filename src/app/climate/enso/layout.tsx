...
export default function EnsoLayout({ children }: { children: React.ReactNode }) {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        '@type': 'Question',
        name: 'Which countries are most affected by El Niño?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'El Niño typically brings heavier rainfall and flooding to Peru, Ecuador, the southern United States and parts of East Africa (Kenya, Tanzania, Somalia). It causes drought across Indonesia, Australia, the Philippines, Papua New Guinea, southern Africa (Zimbabwe, South Africa, Mozambique) and the Amazon basin. Northern South America (Colombia, Venezuela) and the Caribbean also tend to be drier than average.',
        },
      },
      {
        '@type': 'Question',
        name: 'Which countries are most affected by La Niña?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'La Niña broadly flips the El Niño pattern. It brings wetter conditions to Australia, Indonesia, the Philippines, southern Africa and the Amazon, but drought to the Horn of Africa (Somalia, Ethiopia, Kenya), the southern United States, Argentina, Uruguay and southern Brazil. La Niña also boosts Atlantic hurricane activity and tends to suppress eastern Pacific hurricanes.',
        },
      },
      {
        '@type': 'Question',
        name: 'Why does El Niño cause floods in some places and drought in others?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'During El Niño the warm pool of water that normally sits in the western Pacific shifts eastward toward South America. Atmospheric convection — the rising air that produces rain — follows it. So Indonesia and Australia, which usually sit under that rising air, lose their rainfall, while Peru and Ecuador get downpours from convection that has moved over them. The shift also rearranges the global jet streams, which is why effects show up as far away as East Africa and the southern US.',
        },
      },
      {
        '@type': 'Question',
        name: 'What is the difference between El Niño and La Niña?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'They are opposite phases of the same Pacific climate cycle (ENSO). El Niño is the warm phase: equatorial Pacific surface waters are 0.5 °C or more above average, trade winds weaken, and global average temperatures briefly rise. La Niña is the cool phase: equatorial Pacific waters are 0.5 °C or more below average, trade winds strengthen, and global temperatures briefly dip. Each phase lasts roughly 9–18 months and they alternate (with Neutral years) on a 2–7 year cycle.',
        },
      },
      {
        '@type': 'Question',
        name: 'When was the last major El Niño?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'The most recent El Niño peaked in late 2023 / early 2024 with a peak ONI around +2.0 °C, classed as a strong event. Combined with long-term warming it helped push 2023 and 2024 to record-warm globally. Other recent strong El Niños were 2015–16 and 1997–98 (the strongest in the modern record). The most recent prolonged La Niña was the rare triple-dip event of 2020–23.',
        },
      },
    ],
  };
