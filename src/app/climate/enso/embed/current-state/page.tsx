...
import CurrentStateSection from '../../_components/CurrentStateSection';
import type { EnsoSnapshot } from '../../types';

export default function EmbedCurrentStatePage() {
  ...
  return (
    <div className="p-3">
      ...
      <div className="mt-2 flex justify-end">
        <a
          href="https://4billionyearson.org/climate/enso#current-state"
          target="_blank"
