...
function DatasetSchema() {
  ...
  const schema = {
    ...
    distribution: [
      { '@type': 'DataDownload', name: 'NOAA Climate at a Glance - Global Land+Ocean', contentUrl: 'https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/global/time-series', encodingFormat: 'text/html' },
      { '@type': 'DataDownload', name: 'Our World in Data / ERA5 - Global Land Surface Temperature', contentUrl: 'https://ourworldindata.org/temperature-anomaly', encodingFormat: 'text/html' },
      { '@type': 'DataDownload', name: 'NOAA Global Monitoring Laboratory - CO₂ / CH₄ / N₂O', contentUrl: 'https://gml.noaa.gov/ccgg/trends/', encodingFormat: 'text/html' },
      { '@type': 'DataDownload', name: 'NSIDC - Sea Ice Index (Arctic / Antarctic extent)', contentUrl: 'https://nsidc.org/data/g02135', encodingFormat: 'text/html' },
      { '@type': 'DataDownload', name: 'NOAA CPC - ENSO (Niño 3.4)', contentUrl: 'https://www.cpc.ncep.noaa.gov/data/indices/', encodingFormat: 'text/html' },
      { '@type': 'DataDownload', name: 'Our World in Data - Global CO₂ emissions', contentUrl: 'https://ourworldindata.org/co2-emissions', encodingFormat: 'text/html' },
      { '@type': 'DataDownload', name: 'Ember / Our World in Data - Global electricity mix', contentUrl: 'https://ember-climate.org/data/data-explorer/', encodingFormat: 'text/html' },
      { '@type': 'DataDownload', name: 'IPCC AR6 Synthesis - Paris Agreement 1.5°C / 2.0°C basis', contentUrl: 'https://www.ipcc.ch/report/ar6/syr/', encodingFormat: 'text/html' },
    ],
