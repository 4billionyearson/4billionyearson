...
const FEATURED = [
  { title: 'Breathless', author: 'David Quammen' },
  { title: 'The Song of the Cell', author: 'Siddhartha Mukherjee' },
  { title: 'The Vaccine', author: 'Joe Miller, Ugur Sahin & Ozlem Tureci' },
];
        ...
        >
          ...
          <div style={{ display: 'flex', marginBottom: '28px' }}>
            <span style={{ fontSize: 26, color: '#e2e8f0', lineHeight: 1.35, textShadow: '0 2px 8px rgba(0,0,0,0.9)' }}>
              Gene editing, CRISPR, synthetic biology and the future of medicine - from pioneering scientists and bestselling authors.
            </span>
          </div>
