...
import { Loader2, Activity, Snowflake, Waves, Thermometer, ArrowUp, Link2, MapPin, BookOpen } from 'lucide-react';
import { StaticFAQPanel, FaqJsonLd } from '@/app/_components/seo/StaticFAQPanel';
import { SEA_LEVELS_ICE_FAQ } from './sea-levels-ice-faq';
    ...
    <main>
      <div className="container mx-auto px-3 md:px-4 pt-2 pb-6 md:pt-4 md:pb-8 font-sans text-gray-200">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <StaticFAQPanel headingId="sea-levels-ice-faq-heading" qa={SEA_LEVELS_ICE_FAQ} />
          <FaqJsonLd qa={SEA_LEVELS_ICE_FAQ} />
        </div>
      </div>
    </main>
  );
