...
export const metadata: Metadata = {
  alternates: { canonical: 'https://4billionyearson.org/climate-books' },
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="space-y-6">
            {BOOKS.map((book, index) => (
              <section
                key={book.asin}
                className="bg-gray-950/90 backdrop-blur-md rounded-2xl shadow-xl border-2 border-[#D0A65E] overflow-hidden"
              >
                {/* Accent header bar */}
                <div className="px-5 py-3 flex items-center justify-between" style={{ backgroundColor: '#D0A65E' }}>
                  <h2 className="text-lg md:text-xl font-bold font-mono text-[#FFF5E7] truncate pr-4">
                    <span className="text-[#FFF5E7]/50 mr-2">#{index + 1}</span>
                    {book.title}
                  </h2>
                  <div className="flex items-center gap-1 flex-shrink-0">
                    <Star className="h-4 w-4 text-amber-500 fill-amber-500" />
                    <span className="text-sm font-bold text-[#FFF5E7]">{book.rating}</span>
                  </div>
                </div>
                ...
                <div className="p-5 md:p-6">
                  <div className="flex gap-5">
                    ...
                    <div className="flex flex-col items-center gap-3 flex-shrink-0 w-[100px] sm:w-[130px] md:w-[150px]">
                      ...
                      <a
                        ...
                        className="w-full text-center bg-[#D0A65E] text-[#FFF5E7] font-bold text-xs py-1.5 px-2 rounded-lg hover:bg-[#B38D4F] transition-colors flex items-center justify-center gap-1"
                      >
                    ...
                    <div className="flex-1 min-w-0 space-y-3">
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-1">
                        {book.bestFor.map((tag, i) => (
                          <span key={i} className="bg-[#D0A65E]/10 text-[#D0A65E] text-xs px-2.5 py-0.5 rounded-full border border-[#D0A65E]/30 font-medium">
                            {tag}
                          </span>
                        ))}
                      </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    ...
                    <a href={book.dataConnection.link} className="text-xs text-[#D0A65E] font-bold uppercase tracking-wide hover:underline whitespace-nowrap flex-shrink-0">
                      View Data &rarr;
                    </a>
                  </div>
                </div>
