...
export const COUNTRY_TOP_CITIES: Record<string, string[]> = {
  ...
  // Europe (additional)
  ALB: ['Tirana', 'Durrës', 'Vlorë', 'Shkodër', 'Fier'],
  ARM: ['Yerevan', 'Gyumri', 'Vanadzor', 'Vagharshapat', 'Abovyan'],
  AZE: ['Baku', 'Ganja', 'Sumqayit', 'Lankaran', 'Mingachevir'],
  BLR: ['Minsk', 'Gomel', 'Mogilev', 'Vitebsk', 'Grodno'],
  BIH: ['Sarajevo', 'Banja Luka', 'Tuzla', 'Zenica', 'Mostar'],
  BGR: ['Sofia', 'Plovdiv', 'Varna', 'Burgas', 'Ruse'],
  HRV: ['Zagreb', 'Split', 'Rijeka', 'Osijek', 'Zadar'],
  EST: ['Tallinn', 'Tartu', 'Narva', 'Pärnu', 'Kohtla-Järve'],
  GEO: ['Tbilisi', 'Kutaisi', 'Batumi', 'Rustavi', 'Gori'],
  KAZ: ['Almaty', 'Astana', 'Shymkent', 'Aktobe', 'Karaganda'],
  XKX: ['Pristina', 'Prizren', 'Peja', 'Ferizaj', 'Gjakova'],
  KGZ: ['Bishkek', 'Osh', 'Jalal-Abad', 'Karakol', 'Tokmok'],
  LVA: ['Riga', 'Daugavpils', 'Liepāja', 'Jelgava', 'Jūrmala'],
  LTU: ['Vilnius', 'Kaunas', 'Klaipėda', 'Šiauliai', 'Panevėžys'],
  LUX: ['Luxembourg City', 'Esch-sur-Alzette', 'Differdange', 'Dudelange', 'Ettelbruck'],
  MDA: ['Chișinău', 'Tiraspol', 'Bălți', 'Bender', 'Rîbnița'],
  MNE: ['Podgorica', 'Nikšić', 'Pljevlja', 'Bar', 'Bijelo Polje'],
  MKD: ['Skopje', 'Bitola', 'Kumanovo', 'Tetovo', 'Veles'],
  SRB: ['Belgrade', 'Novi Sad', 'Niš', 'Kragujevac', 'Subotica'],
  SVK: ['Bratislava', 'Košice', 'Prešov', 'Žilina', 'Nitra'],
  SVN: ['Ljubljana', 'Maribor', 'Celje', 'Kranj', 'Velenje'],
  TJK: ['Dushanbe', 'Khujand', 'Kulob', 'Qurghonteppa', 'Istaravshan'],
  TKM: ['Ashgabat', 'Türkmenabat', 'Daşoguz', 'Mary', 'Balkanabat'],
  UZB: ['Tashkent', 'Samarkand', 'Namangan', 'Andijan', 'Bukhara'],
  // Americas (additional)
  BHS: ['Nassau', 'Freeport', 'West End', 'Cooper\'s Town', 'Marsh Harbour'],
  BLZ: ['Belize City', 'San Ignacio', 'Belmopan', 'Orange Walk', 'Dangriga'],
  CUB: ['Havana', 'Santiago de Cuba', 'Camagüey', 'Holguín', 'Guantánamo'],
  DOM: ['Santo Domingo', 'Santiago', 'La Romana', 'San Pedro de Macorís', 'San Cristóbal'],
  ECU: ['Guayaquil', 'Quito', 'Cuenca', 'Ambato', 'Portoviejo'],
  SLV: ['San Salvador', 'Soyapango', 'Santa Ana', 'San Miguel', 'Mejicanos'],
  GTM: ['Guatemala City', 'Mixco', 'Villa Nueva', 'Quetzaltenango', 'Escuintla'],
  HTI: ['Port-au-Prince', 'Cap-Haïtien', 'Delmas', 'Port-de-Paix', 'Carrefour'],
  HND: ['Tegucigalpa', 'San Pedro Sula', 'La Ceiba', 'El Progreso', 'Choloma'],
  PAN: ['Panama City', 'San Miguelito', 'Tocumen', 'La Chorrera', 'Colón'],
  PRY: ['Asunción', 'Ciudad del Este', 'San Lorenzo', 'Luque', 'Capiatá'],
  PRI: ['San Juan', 'Bayamón', 'Carolina', 'Ponce', 'Caguas'],
  TTO: ['Port of Spain', 'San Fernando', 'Arima', 'Chaguanas', 'San Juan'],
  URY: ['Montevideo', 'Salto', 'Paysandú', 'Las Piedras', 'Rivera'],
  VEN: ['Caracas', 'Maracaibo', 'Valencia', 'Barquisimeto', 'Maracay'],
  // Africa (additional)
  AFG: ['Kabul', 'Kandahar', 'Herat', 'Mazar-i-Sharif', 'Kunduz'],
  AGO: ['Luanda', 'Huambo', 'Lobito', 'Benguela', 'Kuito'],
  BEN: ['Cotonou', 'Porto-Novo', 'Parakou', 'Abomey-Calavi', 'Bohicon'],
  BTN: ['Thimphu', 'Phuntsholing', 'Paro', 'Punakha', 'Wangdue Phodrang'],
  BWA: ['Gaborone', 'Francistown', 'Molepolole', 'Serowe', 'Maun'],
  BFA: ['Ouagadougou', 'Bobo-Dioulasso', 'Koudougou', 'Ouahigouya', 'Banfora'],
  BDI: ['Bujumbura', 'Gitega', 'Muyinga', 'Ruyigi', 'Ngozi'],
  CMR: ['Yaoundé', 'Douala', 'Garoua', 'Kousséri', 'Bafoussam'],
  CAF: ['Bangui', 'Bimbo', 'Mbaïki', 'Berbérati', 'Kaga-Bandoro'],
  TCD: ['N\'Djamena', 'Moundou', 'Sarh', 'Abéché', 'Kélo'],
  CIV: ['Abidjan', 'Bouaké', 'Daloa', 'Yamoussoukro', 'San-Pédro'],
  DJI: ['Djibouti City', 'Ali Sabieh', 'Dikhil', 'Tadjourah', 'Obock'],
  GNQ: ['Malabo', 'Bata', 'Ebebiyín', 'Akonibe', 'Luba'],
  ERI: ['Asmara', 'Keren', 'Sawa', 'Massawa', 'Assab'],
  GAB: ['Libreville', 'Port-Gentil', 'Franceville', 'Oyem', 'Moanda'],
  GMB: ['Banjul', 'Serekunda', 'Brikama', 'Bakau', 'Farafenni'],
  GRL: ['Nuuk', 'Sisimiut', 'Ilulissat', 'Qaqortoq', 'Aasiaat'],
  GIN: ['Conakry', 'Nzérékoré', 'Kindia', 'Kankan', 'Labé'],
  GNB: ['Bissau', 'Bafatá', 'Gabu', 'Bissorã', 'Bolama'],
  JOR: ['Amman', 'Zarqa', 'Irbid', 'Aqaba', 'Madaba'],
  KWT: ['Kuwait City', 'Ahmadi', 'Hawalli', 'Salmiya', 'Jahra'],
  LAO: ['Vientiane', 'Savannakhet', 'Pakse', 'Luang Prabang', 'Thakhek'],
  LSO: ['Maseru', 'Teyateyaneng', 'Mafeteng', 'Leribe', 'Maputsoe'],
  LBR: ['Monrovia', 'Gbarnga', 'Kakata', 'Bensonville', 'Harper'],
  LBY: ['Tripoli', 'Benghazi', 'Misrata', 'Bayda', 'Zawiya'],
  MDG: ['Antananarivo', 'Toamasina', 'Antsirabe', 'Fianarantsoa', 'Mahajanga'],
  MLI: ['Bamako', 'Sikasso', 'Mopti', 'Koulikoro', 'Kayes'],
  MRT: ['Nouakchott', 'Nouadhibou', 'Néma', 'Kaédi', 'Rosso'],
  MNG: ['Ulaanbaatar', 'Erdenet', 'Darkhan', 'Choibalsan', 'Mörön'],
  MOZ: ['Maputo', 'Matola', 'Beira', 'Nampula', 'Chimoio'],
  NAM: ['Windhoek', 'Rundu', 'Walvis Bay', 'Oshakati', 'Swakopmund'],
  NPL: ['Kathmandu', 'Pokhara', 'Lalitpur', 'Bharatpur', 'Birgunj'],
  NCL: ['Nouméa', 'Mont-Dore', 'Dumbéa', 'Paita', 'Lifou'],
  NER: ['Niamey', 'Zinder', 'Maradi', 'Agadez', 'Arlit'],
  OMN: ['Muscat', 'Seeb', 'Salalah', 'Bawshar', 'Sohar'],
  PNG: ['Port Moresby', 'Lae', 'Arawa', 'Mount Hagen', 'Popondetta'],
  QAT: ['Doha', 'Al Rayyan', 'Al Wakrah', 'Al Khor', 'Mesaieed'],
  RWA: ['Kigali', 'Butare', 'Gitarama', 'Ruhengeri', 'Gisenyi'],
  SEN: ['Dakar', 'Touba', 'Thiès', 'Rufisque', 'Saint-Louis'],
  SLE: ['Freetown', 'Bo', 'Kenema', 'Koidu', 'Makeni'],
  SLB: ['Honiara', 'Gizo', 'Auki', 'Noro', 'Tulagi'],
  SDN: ['Khartoum', 'Omdurman', 'Khartoum North', 'Port Sudan', 'Kassala'],
  TLS: ['Dili', 'Baucau', 'Maliana', 'Suai', 'Lospalos'],
  TGO: ['Lomé', 'Sokodé', 'Kara', 'Atakpamé', 'Datcha'],
  TUN: ['Tunis', 'Sfax', 'Sousse', 'Ettadhamen', 'Kairouan'],
  VUT: ['Port Vila', 'Luganville', 'Isangel', 'Sola', 'Lakatoro'],
  YEM: ['Sanaa', 'Aden', 'Taiz', 'Hodeidah', 'Ibb'],
  ZMB: ['Lusaka', 'Kitwe', 'Ndola', 'Kabwe', 'Livingstone'],
  ZWE: ['Harare', 'Bulawayo', 'Chitungwiza', 'Mutare', 'Gweru'],
};
